...
def get_args_from_command_line():
    parser = ArgumentParser(description='Parser of Runner of DeepSaliencyED')
    parser.add_argument(
    ...
    parser.add_argument(
        '--dataset', dest='dataset', help='The name of the dataset to use', default=cfg.DATASET.DATASET_NAME, type=str)
...
if __name__ == '__main__':
    ...
    if sys.version_info < (3, 0):
        raise Exception("Please follow the installation instruction on 'https://github.com/hzxie/DeepGaze'")
